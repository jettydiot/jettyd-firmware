 ...
 *
 * In a real build this would be auto-generated by build.py to register
 * whichever drivers are included in the project. For the template, it
 * is a no-op — drivers are registered manually or not at all.
 */
void jettyd_register_drivers(void)
{
    /* No drivers auto-registered in the template build.
     * Add calls to individual driver register functions here as needed. */
}

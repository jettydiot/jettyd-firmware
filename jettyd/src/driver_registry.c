...
/**
 * @brief Register all compiled-in drivers (weak default — no-op).
 *
 * The user's project overrides this in main/driver_registry.c (auto-generated
 * by build.py from device.yaml). The weak attribute ensures the linker always
 * picks the user's version over this stub.
 */
__attribute__((weak)) void jettyd_register_drivers(void)
{
    /* No-op stub — overridden by the generated main/driver_registry.c */
}

 ...
 *
 * Defined in main/driver_registry.c (auto-generated by build.py from device.yaml).
 * Call this from app_main() AFTER jettyd_init() and BEFORE jettyd_start().
 * jettyd_init() zeroes the registry; jettyd_start() reads it.
 *
 * Example:
 * @code
 *   void app_main(void) {
 *       jettyd_init(&config);
 *       jettyd_register_drivers();   // registers LED, button, sensors etc.
 *       jettyd_start();
 *   }
 * @endcode
 */

...
void bme280_register(const char *instance, const void *config)
{
    ...
    strlcpy(s_driver.driver_name, "bme280", sizeof(s_driver.driver_name));
    ...
    strlcpy(s_driver.capabilities[0].unit, "C", sizeof(s_driver.capabilities[0].unit));
    ...
    strlcpy(s_driver.capabilities[2].name, "pressure", sizeof(s_driver.capabilities[2].name));
    ...
    strlcpy(s_driver.capabilities[2].unit, "hPa", sizeof(s_driver.capabilities[2].unit));
